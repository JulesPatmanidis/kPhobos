...
num="$(($1-1))"
./lte-uesoftmodem -O ue.conf --L2-emul 5 --nokrnmod 1 --nsa --num-ues 2 --node-number 1 --num-enbs 2 --log_config.global_log_options level,nocolor,time,thread_id | tee ue.log 2>&1
